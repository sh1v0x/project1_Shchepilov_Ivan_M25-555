ROOMS = {
    ...
    'hidden_passage': {
          'description': 'Узкий тайный проход. Потолок низкий, приходится наклоняться. На стене кто-то выцарапал странные символы.',
          'exits': {"south": "hall", "east": "observatory"},
          'items': ["mysterious_symbol"],
          'puzzle': ('Символы складываются в число: 2, 3 и ещё одно число, которое делает сумму равной 10. Введите недостающее число.', '5')
    },
    'observatory': {
          'description': 'Небольшая круглая комната с куполом. В потолке — отверстие, через которое видно звёздное небо.'
          'exits': {"west": "hidden_passage"},
          'items': ["star_map"],
          'puzzle': ('Надпись на стене: "Я всегда над вами, но меня не видно днём. Кто я?" (одним словом)', 'звезды')
    },
}
